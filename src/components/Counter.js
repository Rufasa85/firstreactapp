...
export default function Counter(props) {
  ...
  let [count, setCount] = useState(props.startAt || 0);
  ...
  return (
    <div className="card text-center">
      ...
      <div className="card-body">
        ...
        <button className="btn btn-danger" type="button" onClick={handleDecClick}>
          Decrement
        </button>
        <button className="btn btn-success" type="button" onClick={()=>setCount(props.startAt||0)}>
          Reset
        </button>
      </div>
    </div>
